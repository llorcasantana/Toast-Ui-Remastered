    ...
    <ul class="tui-image-editor-submenu-item">
        <li class="tui-image-editor-submenu-align">
            <div class="tui-image-editor-range-wrap tui-image-editor-newline">
                ...
                <input class="tie-width-range-value tui-image-editor-range-value" value="0" /> <label>cm</label>
                ...
                <input class="tie-height-range-value tui-image-editor-range-value" value="0" /> <label>cm</label>
            </div>
        </li>
