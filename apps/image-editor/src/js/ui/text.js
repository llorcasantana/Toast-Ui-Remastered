...
class Text extends Submenu {
  constructor(subMenuElement, { locale, makeSvgIcon, menuBarPosition, usageStatistics }) {
    ...
    this._els = {
      ...
      textFontFamily: this.selector('.tie-text-font-family'),
  ...
  addEvent(actions) {
    ...
    this._els.textFontFamily.addEventListener('change', this._changeTextFontFamily.bind(this));
  ...
  setTextStyleStateOnAction(textStyle = {}) {
    ...
    const { fill, fontSize, fontStyle, fontWeight, textDecoration, textAlign, fontFamily } =
      textStyle;
  ...
  // eslint-disable-next-line no-unused-vars
  _changeTextFontFamily(fontSelected) {
    this.actions.changeTextStyle({
      fontFamily: fontSelected.target.options[fontSelected.target.options.selectedIndex].value,
    });
    this.fontFamily = fontSelected.target.options[fontSelected.target.options.selectedIndex].value;
  }
